	...
	return (
		<div className='bg-indigo-950 rounded-md overflow-hidden'>
			...
			<div className='p-6'>
				...
				<h1 className='sm:text-lg text-base cursor-pointer horver:text-gray-200 hover:underline transition-all duration-200 mt-6 mb-2 text-gray-200 leading-[1.6rem] font-bold  '>
					{title}
				</h1>
